...
class UNetConvBlock(nn.Module):
    def __init__(self, in_size, out_size, padding=False, batch_norm=False):
...
class ConvBlock(nn.Module):
    def __init__(self, in_size, out_size, padding=False, batch_norm=False):
        ...
        block.append(nn.Conv2d(in_size, out_size, kernel_size=100, padding=int(padding)))
        block.append(nn.ReLU())
        if batch_norm:
            block.append(nn.BatchNorm2d(out_size))

        block.append(nn.Conv2d(out_size, out_size, kernel_size=100, padding=int(padding)))
        block.append(nn.ReLU())
        if batch_norm:
            block.append(nn.BatchNorm2d(out_size))

        block.append(nn.Conv2d(out_size, in_size, kernel_size=100, padding=int(padding)))
